...
const double FLANGER_MIN_DELAY_TIME_MS = 1.0;
// maximum delay time for modulation
const double FLANGER_MAX_DELAY_TIME_MS = 10.0;

//==============================================================================
/**
*/
class JustFlangerAudioProcessor  : public juce::AudioProcessor, juce::AudioProcessorValueTreeState::Listener
...
public:
    //==============================================================================
    JustFlangerAudioProcessor();
    ~JustFlangerAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JustFlangerAudioProcessor)
};
